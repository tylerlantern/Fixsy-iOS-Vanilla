            ...
            Form {
              Section(
                ...
                if self.showRateError {
                  Text(
                    String(
                      localized: "We need your satisfaction rate for this place",
                      bundle: .module
                    )
                  )
              ...
              if self.hasCarGarage {
                Section(
                    ...
                    if self.carBrands.isEmpty {
                      Button {
                        ...
                        HStack {
                          ...
                          Text(
                            String(
                              localized: "Click me to select at least one brand.",
                              bundle: .module
                            )
                          )
                          Spacer()
                  ...
                  if self.showCarBrandsError {
                    Text(
                      String(
                        localized: "Required at least 1 brand.",
                        bundle: .module
                      )
                    )
                    .font(.system(size: 12, weight: .regular, design: .default))
              ...
              Section(
                String(
                  localized: "Tell the community your story.",
                  bundle: .module
                )
              ) {
                TextField(
                  String(
                    localized: "Tell us about this place's service.",
                    bundle: .module
                  ),
                  text: self.$tellStory,
                  axis: .vertical
              ...
              Section(
                ...
                Button {
                  ...
                  HStack {
                    ...
                    Text(
                      String(
                        localized: "Select Multiple Photos",
                        bundle: .module
                      )
                    )
                    Spacer()

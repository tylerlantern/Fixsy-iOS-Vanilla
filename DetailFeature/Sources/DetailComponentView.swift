...
public struct DetailComponentView: View {
...
public extension Place {
  ...
  static func shimmer(
    ...
    carGarage: CarGarage? = nil,
    openCloseTime: OpenCloseTime = .empty,
    images: [Image] = [
      Image(id: 1, url: URL(string: "https://picsum.photos/300")!),
      Image(id: 2, url: URL(string: "https://picsum.photos/300")!)
    ],

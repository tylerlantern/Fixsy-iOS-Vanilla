...
public struct DatabaseClient {
  public init(
    ...
    observeMapData: @escaping @Sendable (PlaceFilter) -> AsyncThrowingStream<[Place], Error>,
  ...
  public var observeMapData: @Sendable (PlaceFilter) -> AsyncThrowingStream<[Place], Error>

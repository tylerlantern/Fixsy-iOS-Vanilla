...
struct SortItemsByNearestTests {
  ...
  func sortsAscending_withUserLocation() {
    ...
    let near = self.place(id: 1, name: "Pathum Thani", lat: 14.017, lon: 100.530)
    let far = self.place(id: 2, name: "Chiang Mai", lat: 18.7883, lon: 98.9853)
  ...
  func noLocation_keepsOrderAndNilDistances() {
    let a = self.place(id: 10, name: "A", lat: 15.0, lon: 100.0)
    let b = self.place(id: 20, name: "B", lat: 16.0, lon: 101.0)
